...
def main():
    ...
    parser.add_argument('-r', '--restore', help='Restore Mode', required=False, action='store_true')
    parser.add_argument('-b', '--boot', help='Boot Mode', required=False, action='store_true')
    parser.add_argument('-d', '--boardconfig', help='BoardConfig to use', required=True)
    parser.add_argument('-kpp', '--kpp', help='Use KPP', required=False, action='store_true')
